...
If you are creating or configuring a Red Hat OpenShift Cluster on Power Systems Virtual Server, see [Getting started with Red Hat OpenShift on Power Systems Virtual Server](https://developer.ibm.com/learningpaths/getting-started-openshift-powervs/){: external}.
